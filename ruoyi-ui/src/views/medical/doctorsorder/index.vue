<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['medical:doctorsorder:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['medical:doctorsorder:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['medical:doctorsorder:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="doctorsorderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="医嘱记录id" align="center" prop="id" />
      <el-table-column label="患者id" align="center" prop="personId" />
      <el-table-column label="主治医生d" align="center" prop="doctorId" />
...
<script>
import { listDoctorsorder, getDoctorsorder, delDoctorsorder, addDoctorsorder, updateDoctorsorder, exportDoctorsorder } from "@/api/medical/doctorsorder";

export default {
  name: "Doctorsorder",
  dicts: ['medical_doctorsOrder_type', 'medical_doctorsOrder_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
