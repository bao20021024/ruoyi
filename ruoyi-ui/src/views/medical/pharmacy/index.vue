<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['medical:pharmacy:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['medical:pharmacy:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['medical:pharmacy:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['medical:pharmacy:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="pharmacyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药房库存id" align="center" prop="id" />
      <el-table-column label="药品名称id" align="center" prop="drugsId" />
      <el-table-column label="药房名称" align="center" prop="name" />
...
<script>
import { listPharmacy, getPharmacy, delPharmacy, addPharmacy, updatePharmacy, exportPharmacy } from "@/api/medical/pharmacy";
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有药房库存数据项?', "警告", {
          ...
          return exportPharmacy(queryParams);
        }).then(response => {
