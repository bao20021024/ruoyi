<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="生成日期" prop="manufactureTime">
      ...
      <el-form-item label="摘要" prop="myabstract">
        <el-input
          v-model="queryParams.myabstract"
          placeholder="请输入摘要"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['medical:purchase:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['medical:purchase:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['medical:purchase:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['medical:purchase:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="purchaseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生成日期" align="center" prop="manufactureTime" width="180">
      ...
      <el-table-column label="摘要" align="center" prop="myabstract" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="药品采购信息id" prop="id">
          <el-input v-model="form.id" placeholder="请输入药品采购信息id" />
        </el-form-item>
        <el-form-item label="药品名称id" prop="drugsId">
        ...
        <el-form-item label="摘要" prop="myabstract">
          <el-input v-model="form.myabstract" placeholder="请输入摘要" />
        </el-form-item>
        <el-form-item label="填制人" prop="FilledBy">
...
<script>
import { listPurchase, getPurchase, delPurchase, addPurchase, updatePurchase, exportPurchase } from "@/api/medical/purchase";
