    ...
    <el-table v-loading="loading" :data="receiverecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.medical_bill_type" :value="scope.row.status"/>
        </template>
      </el-table-column>
...
<script>
import { listReceiverecord, getReceiverecord, delReceiverecord, addReceiverecord, updateReceiverecord, exportReceiverecord } from "@/api/medical/receiverecord";

export default {
  name: "Receiverecord",
  dicts: ['medical_bill_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
