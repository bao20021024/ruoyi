<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['medical:splitbed:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['medical:splitbed:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['medical:splitbed:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="splitbedList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分床记录id" align="center" prop="id" />
      <el-table-column label="患者id" align="center" prop="personId" />
      <el-table-column label="主治医师id" align="center" prop="doctorId" />
...
<script>
import { listSplitbed, getSplitbed, delSplitbed, addSplitbed, updateSplitbed, exportSplitbed } from "@/api/medical/splitbed";
